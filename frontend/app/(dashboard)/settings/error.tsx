  ...
  return (
    <div className="space-y-5 max-w-2xl">
      <div>
        ...
        <p className="text-[13px] text-gray-500 mt-0.5">Something went wrong loading settings.</p>
      </div>
      <div
        className="bg-white rounded-[10px] p-8 text-center"
        style={{ border: '0.5px solid #e5e7eb' }}
      >
        <p className="text-[13px] text-[#A32D2D] mb-4">{error.message || 'Failed to load settings.'}</p>
        <button
          onClick={reset}
