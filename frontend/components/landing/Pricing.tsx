...
const TIER_META = [
  {
    ...
    label: 'Starter',
    sublabel: 'STARTER',
    features: ['2 Staff Seats', '15 Students', '750k AI Tokens / mo', 'Core AI Counselor', 'Standard Templates'],
    cta: 'Start Trial',
    href: '/request-access',
  },
  {
    ...
    features: ['4 Staff Seats', '35 Students', '2.5M AI Tokens / mo', 'Advanced AI Analysis', 'Custom Branded Portals', 'Priority 24/7 Support'],
    cta: 'Get Started',
    href: '/login',
  },
  {
